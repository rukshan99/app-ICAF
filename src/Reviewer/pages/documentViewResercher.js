...
class resercherDocument extends Component{
    ...
    componentDidMount(){
        ...
        axios.get(`http://localhost:4000/api/v1/reviewer/user/${this.props.match.params.id}`)
        .then(response => { 
     ...
     OnAccept(e) {   
        const Data ={
         ...
         axios.put(`http://localhost:4000/api/v1/reviewer/researcher/update/${this.props.match.params.id}`, Data )
